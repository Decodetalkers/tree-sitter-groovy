...
enum {
  ...
  aux_sym_command_repeat1 = 37,
  aux_sym_unit_repeat1 = 38,
  aux_sym_string_repeat1 = 39,
  aux_sym_string_repeat2 = 40,
  aux_sym__args_repeat1 = 41,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_unit_repeat1, 2), SHIFT_REPEAT(60),
  ...
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_func, 2),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_func, 2),
  ...
  [185] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_unit_repeat1, 2), SHIFT_REPEAT(61),
  ...
  [206] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_string_repeat2, 2), SHIFT_REPEAT(66),
