...
module.exports = grammar({
  ...
  rules: {
    ...
    block: ($) => seq($._command_unit, "{", repeat($.command), optional($.end_command), "}"),
    ...
    generics_class: ($) => seq($.identifier, "<", field("generics_type", $.identifier), ">"),
    ...
    _args: ($) =>
      seq(
        ...
        repeat(seq(optional($.arg_spliter), choice($.string, $.unit, $.list, $.operators, $.arg_block)))
      ),
